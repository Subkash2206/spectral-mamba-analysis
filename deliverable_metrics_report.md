...
3.  **Robustness**: VM-UNet achieves superior shift-consistency versus Swin-Tiny at all shift magnitudes (Shift-5: Mamba 0.9531 vs. Swin 0.9285), showing that the dual-stage spectral behavior does not induce translational instability.
