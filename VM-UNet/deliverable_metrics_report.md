...
| **Partial (Controlled)** | +0.0004 | 0.9965 | No structural link |
...
- **Corrected Finding**: Pooled r = **+0.0541 (p=0.51)**, partial r = **+0.0004 (p=0.99)**.
...
*   **Validation**: 80/20 shuffle split (Seed 42), held-out ISIC18 validation, $N=519$.
