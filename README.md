...
| **VM-UNet (Mamba)** | Selective Scan | **0.9167** | 0.3139 | 0.1622 |

### Key Findings:
- **Mamba Paradox**: VM-UNet achieves superior global accuracy (Dice) but struggles with boundary precision (BF1) due to significantly higher spectral aliasing (up to 2x higher peak AVR than Transformer at early high-resolution stages).
- **Spectral Debt**: We observe a strong relationship between early-stage internal aliasing and boundary localization error in State Space Models.
